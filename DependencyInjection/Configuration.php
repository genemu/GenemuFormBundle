            ...
            ->children()
                ->arrayNode('captcha')
                    ...
                    ->children()
                        ...
                        ->scalarNode('code_encoder')->defaultValue('genemu.form.captcha.code_encoder.default')->end()
                        ->scalarNode('code_generator')->defaultValue('genemu.form.captcha.code_generator.default')->end()
                        ->scalarNode('invalid_message')->defaultValue('The captcha is invalid')->end()
                    ->end()
                ->end()
            ->end()
        ;
